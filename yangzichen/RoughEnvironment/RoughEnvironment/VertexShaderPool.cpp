#include "VertexShaderPool.h"

namespace pool
{
	bool CVertexShaderPool::InitializeVertexShader(LPDIRECT3DDEVICE9 device, TCHAR* file, CHAR* functionName, CHAR* target)
	{
		...
		if (FAILED(device->CreateVertexShader((DWORD*)shader->GetBufferPointer(), &this->mVertexShader)))
		{
